		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zemployeemgmt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zemployeemgmt-display": {
								"semanticObject": "zemployeemgmt",
								"action": "display",
								"description": "Employeee Management for HR",
								"title": "Employee Management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zemployeemgmt",
									"url": sap.ui.require.toUrl("zemployeemgmt")
								}
							}
						}
					}
